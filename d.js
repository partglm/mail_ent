...
async function sendMessage() {
  ...
  try {
    ...
    const sendBody = {
      subject: 'a',
      body: `<div class="ng-scope">​</div><div class="ng-scope">​a</div><div class="ng-scope">CCIDKWHATIDO</div><div class="signature new-signature ng-scope">Cordialement Pierre Goas <br> élève et délégué suppléant <br> de la 3E2</div>`,
      to: ['b551d9ca-5e49-452b-a070-b2efe9ddf4f4'],
      cc: [],
      cci: []
    };
